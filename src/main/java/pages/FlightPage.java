...
public class FlightPage extends Base {
    public boolean SearchOneWayFlight(String fromSource, String toDestination) {
        ...
        WebElement results = new WebDriverWait(driver, Duration.ofSeconds(150))
    ...
    public boolean SearchRoundTripFlight(String fromSource, String toDestination) {
        ...
        WebElement from = driver.findElement(By.id("fromSource"));
        WebElement to = driver.findElement(By.id("destination"));
        actions.moveToElement(from).click().sendKeys(fromSource).pause(Duration.ofSeconds(5)).keyDown(Keys.DOWN).keyDown(Keys.ENTER).build().perform();
        actions.moveToElement(to).click().sendKeys(toDestination).pause(Duration.ofSeconds(5)).keyDown(Keys.DOWN).keyDown(Keys.ENTER).build().perform();
        driver.findElement(By.xpath("//div[@id='round-trip-panel']/div[4]/div[2]/div")).click();
    ...
    public boolean SearchMultiCityFlight(String fromSource, String toDestination, String multiToDestination) {
        ...
        actions.moveToElement(from1).click().sendKeys(fromSource).pause(Duration.ofSeconds(5)).keyDown(Keys.DOWN).keyDown(Keys.ENTER).build().perform();
        actions.moveToElement(to1).click().sendKeys(toDestination).pause(Duration.ofSeconds(5)).keyDown(Keys.DOWN).keyDown(Keys.ENTER).build().perform();
        ...
        actions.moveToElement(to2).click().sendKeys(multiToDestination).pause(Duration.ofSeconds(1)).keyDown(Keys.DOWN).keyDown(Keys.ENTER).build().perform();
